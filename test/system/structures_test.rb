...
class StructuresTest < ApplicationSystemTestCase
  ...
  test "creating a Structure" do
    ...
    fill_in "Active", with: @structure.active
    fill_in "Alias", with: @structure.alias
    fill_in "Ancestry", with: @structure.ancestry
    fill_in "Category", with: @structure.category
    fill_in "Name", with: @structure.name
    fill_in "Structure", with: @structure.structure_id
    fill_in "Type", with: @structure.type
    fill_in "User", with: @structure.user_id
